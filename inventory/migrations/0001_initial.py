# Generated by Django 5.0.1 on 2024-06-16 03:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', models.CharField(max_length=50, null=True)),
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('itemBase_code', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory.itembase')),
